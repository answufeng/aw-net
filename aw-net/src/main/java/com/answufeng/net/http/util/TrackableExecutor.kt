...
/**
 * @param shouldTrack 为 false 时仅执行 [block]，不上报 [NetEventDispatcher] 起止事件（受 [com.answufeng.net.http.config.NetworkConfig.enableRequestTracking] 控制）。
